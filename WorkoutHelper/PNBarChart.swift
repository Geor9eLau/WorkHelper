...
class PNBarChart: UIView {
    ...
    private var xLabelWidth: CGFloat = 35
    ...
    var xLabels = [String]() {
        didSet{
            ...
            self.frame = CGRect(origin: oldFrame.origin, size: CGSize(width: chartMargin * 2 + self.xLabelWidth * CGFloat(xLabels.count), height: oldFrame.size.height))
        }
    }
